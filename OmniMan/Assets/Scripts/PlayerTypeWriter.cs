...
public class PlayerTypeWriter : MonoBehaviour
{
    ...
    public GameObject triggerObject;      // Object that triggers the dialogue box

    void Start()
    {
        if (DialogueBox != null)
        {
            DialogueBox.SetActive(false); // Ensure the dialogue box is initially inactive
        }
    }
